...
### **📝 Exam Solution: 6(b) Smart Parking System using IoT [2x5 = 10 Marks approx or part of 8]**
...
1.  **MQTT Topic (Address lekhne tarika):**
    ...
    *   `Nepal/Kathmandu/CivilMall/Floor1/Slot5` — yesari pathayo vane server le thaha paucha ki thakkai kun thau ko parking full vayo.
...
**Exam Tip:**
Points ma lekhnu, paragraph nalekhnu. "MQTT Topic" ma tyo slash (`/`) wala example (`Mall/Floor/Slot`) dina na-birsine! 🚀
